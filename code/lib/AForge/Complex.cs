...
namespace AForge.Math
{
    ...
    public struct Complex : ICloneable//, ISerializable
    {
        ...
        public static Complex Divide( Complex a, Complex b )
        {
            ...
            if ( modulusSquared == 0 )
            {
				Sandbox.Internal.GlobalGameNamespace.Log.Error( "Can not divide by zero." );
        ...
        public static Complex Parse( string s )
        {
            ...
            {
				Sandbox.Internal.GlobalGameNamespace.Log.Error( "String representation of the complex number is not correctly formatted." );
